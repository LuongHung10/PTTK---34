...
public class ProductServlet extends HttpServlet {
    ...
    private void searchProducts(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<MatHang410> productList = matHangDAO.searchProducts(search);
        ...
        request.getRequestDispatcher("GDtkMatHang410.jsp").forward(request, response);
    }
    ...
    private void showProductDetails(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MatHang410 product = matHangDAO.getMatHang(id);
        ...
        if (product != null) {
            htmlResponse.append("<h2>Chi tiết sản phẩm</h2>")
                        ...
                        .append("<a href='GDtkMatHang410.jsp'>Quay lại trang tìm kiếm</a>");
        } else {
        ...
        request.getRequestDispatcher("GDctMatHang410.jsp").forward(request, response);
    }
